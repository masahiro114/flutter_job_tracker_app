...
import 'package:flutter_job_tracker_app/viewmodel/comparison_viewmodel.dart';
...
class ComparisonPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final viewModel = ComparisonPageViewModel(
      model: ComparisonPageModel.defaultData(),
    );
